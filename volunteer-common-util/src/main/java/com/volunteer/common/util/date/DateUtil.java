package com.volunteer.common.util.date;
...
public class DateUtil {
	...
	public static final int MONTH = 4; //月

	public static final int UPDATEDAY = 5; //修改日期
	...
	public static final String DATE_MMDD_FORMAR_STRING = "MM.dd";// 时间格式化字符串
	public static final String DATE_YYMM_FORMAR_STRING = "yyyy-MM";// 时间格式化字符串
	...
	public static final SimpleDateFormat timeFormatMDD = new SimpleDateFormat(DATE_MMDD_FORMAR_STRING);
	public static final SimpleDateFormat timeFormatYMM = new SimpleDateFormat(DATE_YYMM_FORMAR_STRING);
	 ...
	 * @return String
	 */
	public static String formatDateMDD(Date date) {
		if (date == null) {
			return "";
		} else {
			return timeFormatMDD.format(date);
		}
	}
	 ...
	 * @return String
	 */
	public static String formatDateYMM(Date date) {
		if (date == null) {
			return "";
		} else {
			return timeFormatYMM.format(date);
		}
	}
	...
	public static int compareDate() {
		...
		ZonedDateTime zdt = lastDayOfThisMonth.atStartOfDay(zoneId);
		Date date = Date.from(zdt.toInstant());
		return DateUtil.compareDate(System.currentTimeMillis(), date.getTime());
	}
	...
	* @throws Exception
	...
	public static Date toTheDate(int type, Date date, int amount) throws Exception {
		...
		case MONTH:
			return toTheDate1(Calendar.MONTH, date, amount);
		case UPDATEDAY:
				return toTheDate1(Calendar.DAY_OF_MONTH, date, amount);
		default:
	 ...
	 * @return
	 */
	public static String formateStartDate(String startDate) {
	 ...
	 * @return
	 */
	public static String formateEndDate(String endDate) {
	 ...
	 * @return
	 */
	public static long getIntervalMonths(String openDate, String applyTime) {
